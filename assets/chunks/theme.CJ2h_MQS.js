...
`)}function ae(){if(!u.value)return"";const B=p.value==="custom",g=B?w.value.trim():p.value;if(B&&!/^\d+(?:\.\d+)?$/.test(g))return"";const x=I.find(pn=>pn.version===g),H=x&&"qualifier"in x?`, ${x.qualifier}`:"",we=x?` (${x.name}${H})`:"";return`• Added support for Android ${g}${we}.`}function ln(){return P.filter(B=>V[B]).map(B=>E[B]).join(`
`)}function Me(B,g){V[B]&&(V[g]=!1)}const Be=y(()=>q(o.value)),Ue=y(()=>Array.from(Be.value).length),oe=y(()=>Ue.value>se),ce=y(()=>{const B=Be.value;return B?`<${n.value}>
${B}
...
This release introduces the core app experience with a focus on simplicity, reliability, and smooth performance.`};i.value=s.value!=="first-release",o.value=Array.from(B[s.value]).slice(0,se).join("")}async function un(){var B,g;if(!(!ce.value||oe.value)){try{if(navigator.clipboard&&window.isSecureContext)await navigator.clipboard.writeText(ce.value);else{if(!A.value)throw new Error("Formatted output is unavailable");if(A.value.focus(),A.value.select(),!document.execCommand("copy"))throw new Error("Copy was rejected")}k.value="Copied"}catch{(B=A.value)==null||B.focus(),(g=A.value)==null||g.select(),k.value="Select the formatted text and copy it manually"}L&&clearTimeout(L),L=setTimeout(()=>{k.value=""},2500)}}return be(()=>{L&&clearTimeout(L)}),G([d,i,u,p,w,()=>P.map(B=>V[B])],()=>{o.value=Fe(o.value)}),(B,g)=>(r(),l("section",Sl,[g[24]||(g[24]=a("div",{class:"release-notes-formatter__intro"},[a("p",{class:"store-listing-card__eyebrow"},"Reusable tool"),a("h2",{id:"release-notes-heading"},"Release notes formatter"),a("p",null," Enter user-facing changes only. Google Play allows up to 500 Unicode characters per language and requires the locale tags on separate lines. ")],-1)),a("div",Pl,[a("div",xl,[a("label",null,[g[9]||(g[9]=a("span",null,"Generic note",-1)),K(a("select",{"onUpdate:modelValue":g[0]||(g[0]=x=>s.value=x)},[(r(),l(R,null,M(T,x=>a("option",{key:x.id,value:x.id},v(x.label),9,Al)),64))],512),[[de,s.value]])]),a("button",{type:"button",onClick:dn},"Use generic note"),a("small",null," Inserts an editable English note and adds "+v(e.appName)+" automatically. ",1)]),a("label",Ll,[g[10]||(g[10]=a("span",null,"Language",-1)),K(a("select",{"onUpdate:modelValue":g[1]||(g[1]=x=>n.value=x)},[(r(!0),l(R,null,M(c($l),x=>(r(),l("option",{key:x.code,value:x.code},v(x.label)+" ("+v(x.code)+") ",9,Cl))),128))],512),[[de,n.value]])]),a("fieldset",Tl,[g[21]||(g[21]=a("legend",null,"Formatting options",-1)),a("label",null,[K(a("input",{"onUpdate:modelValue":g[2]||(g[2]=x=>d.value=x),type:"checkbox"},null,512),[[te,d.value]]),g[11]||(g[11]=a("span",null,"Format each custom line as a bullet point",-1))]),a("label",null,[K(a("input",{"onUpdate:modelValue":g[3]||(g[3]=x=>i.value=x),type:"checkbox"},null,512),[[te,i.value]]),a("span",null," Add “We've made "+v(e.appName)+" smoother and more reliable.” and “Refined the overall app experience” ",1)]),a("div",Vl,[a("label",null,[K(a("input",{"onUpdate:modelValue":g[4]||(g[4]=x=>u.value=x),type:"checkbox"},null,512),[[te,u.value]]),g[12]||(g[12]=a("span",null,"Add an Android version support bullet point",-1))]),u.value?(r(),l("div",Il,[a("label",null,[g[14]||(g[14]=a("span",null,"Android version",-1)),K(a("select",{"onUpdate:modelValue":g[5]||(g[5]=x=>p.value=x)},[(r(),l(R,null,M(I,x=>a("option",{key:x.version,value:x.version}," Android "+v(x.version)+" ("+v(x.name)+") ",9,Nl)),64)),g[13]||(g[13]=a("option",{value:"custom"},"Custom version",-1))],512),[[de,p.value]])]),p.value==="custom"?(r(),l("label",Rl,[g[15]||(g[15]=a("span",null,"Custom Android version",-1)),K(a("input",{"onUpdate:modelValue":g[6]||(g[6]=x=>w.value=x),type:"number",min:"1",max:"99",step:"any",inputmode:"decimal",placeholder:"For example, 18 or 8.1"},null,512),[[Qe,w.value]])])):f("",!0)])):f("",!0)]),a("fieldset",Dl,[g[19]||(g[19]=a("legend",null,"Optional platform and quality updates",-1)),g[20]||(g[20]=a("p",null,"Choose only the improvements included in this release.",-1)),a("label",El,[K(a("input",{"onUpdate:modelValue":g[7]||(g[7]=x=>V.crashFixes=x),type:"checkbox"},null,512),[[te,V.crashFixes]]),g[16]||(g[16]=a("span",null,"App crash fixes",-1))]),a("div",Ol,[(r(),l(R,null,M(U,x=>a("section",{key:x.label,class:"release-notes-formatter__platform","aria-label":x.label},[a("strong",null,v(x.label),1),a("label",null,[K(a("input",{"onUpdate:modelValue":H=>V[x.addedKey]=H,type:"checkbox",onChange:H=>Me(x.addedKey,x.improvedKey)},null,40,Bl),[[te,V[x.addedKey]]]),g[17]||(g[17]=a("span",null,"Support added",-1))]),a("label",null,[K(a("input",{"onUpdate:modelValue":H=>V[x.improvedKey]=H,type:"checkbox",onChange:H=>Me(x.improvedKey,x.addedKey)},null,40,Ul),[[te,V[x.improvedKey]]]),g[18]||(g[18]=a("span",null,"Support improved",-1))])],8,Ml)),64))])])]),a("label",Fl,[a("span",zl,[g[22]||(g[22]=a("span",null,"Custom release notes",-1)),a("span",{class:O({"is-over-limit":oe.value})},v(Ue.value)+" / "+v(se)+" characters ",3)]),a("textarea",{value:o.value,rows:"10",placeholder:"Enter one change per line. Bullet symbols are added automatically.",onInput:cn},null,40,Hl)]),a("section",Kl,[a("div",Gl,[a("div",null,[g[23]||(g[23]=a("h3",null,"Play Console format",-1)),a("span",{class:O(["listing-field__count",{"is-over-limit":oe.value}])},v(oe.value?"Reduce selected options to 500 characters":"Ready to paste"),3)]),a("button",{class:"listing-copy-button",type:"button",disabled:!ce.value||oe.value,onClick:un},v(k.value==="Copied"?"Copied":"Copy"),9,Wl)]),a("textarea",{ref_key:"output",ref:A,class:"listing-field__text",value:ce.value,rows:"12",readonly:"","aria-label":"Formatted Google Play release notes",placeholder:"Formatted release notes will appear here.",onFocus:g[8]||(g[8]=x=>{var H;return(H=A.value)==null?void 0:H.select()})},null,40,jl),a("span",ql,v(k.value),1)])]),g[25]||(g[25]=a("p",{class:"release-notes-formatter__hint"}," Only choose languages already added to the app's Google Play store listing. Generic notes are written in English; translate them yourself before selecting another language. ",-1))]))}}),Ql={extends:ir,enhanceApp({app:e}){e.component("AppBreadcrumbs",on),e.component("AppCard",sn),e.component("AppGrid",Qr),e.component("AppOverview",ki),e.component("AppSubnav",rn),e.component("ContactDetails",Li),e.component("CopyStandaloneUrl",Di),e.component("ExternalLinkButton",pe),e.component("StoreListings",_l),e.component("ReleaseNotesFormatter",Jl)}};export{Ql as R,Ho as c,D as u};
