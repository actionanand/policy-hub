export interface PlayStoreLocale {
  code: string
  label: string
}

/** Locales available for manually translated Google Play store listings. */
export const playStoreLocales: PlayStoreLocale[] = [
  ...
  { code: 'fa-AE', label: 'Persian (United Arab Emirates)' },
