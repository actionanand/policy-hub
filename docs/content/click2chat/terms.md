...
WhatsApp, WhatsApp Business, and `wa.me` are external services. Their terms,
privacy practices, availability, account requirements, blocking rules, and
charges apply. The developer does not control message delivery or recipient
identity.

Review the number and message before continuing. Click2Chat only prepares and
opens the external chat action; the external service completes it.
...
security decisions, legal evidence, or another critical purpose.
...
Features, compatibility, and these terms may change as Click2Chat is improved.
Continued use after an updated version is published means the updated terms
apply.
